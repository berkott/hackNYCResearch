...
def make_sphere_data(model_strings):
    ...
    for model_string in model_strings:
        ...
        with open('./data/' + save_string + 'fig_embeddings.pkl', 'rb') as f:
...
def get_data(model_string):
    save_string = model_string.replace('/', '_')
    if os.path.exists('./data/' + save_string + 'fig_embeddings.pkl'):
    ...
    with open('./data/' + save_string + 'fig_embeddings.pkl', 'wb') as f:
        pickle.dump(all_embeddings, f)
    with open('./data/' + save_string + 'fig_generations.pkl', 'wb') as f:
